...
// ITsDescrambler
	...
	virtual const UINT_PTR GetDescramblingState(const WORD wProgramID);
...
// CTsDescrambler
	...
	UINT_PTR m_dwScramblePacketNum;
...
// CPsiTableBase
	...
	ULONGLONG m_dwLastRetryTime;
	UINT_PTR m_dwDescramblingState;
