...
{
	// ビットレート更新
	const ULONGLONG ullCurUpdateTime = ::GetTickCount64();
	
	// 更新周期チェック
	if((ullCurUpdateTime - m_dwLastUpdateTime) < BITRATE_PERIOD)return;
	...
	// 周期更新
	m_dwLastUpdateTime = ullCurUpdateTime;
}
