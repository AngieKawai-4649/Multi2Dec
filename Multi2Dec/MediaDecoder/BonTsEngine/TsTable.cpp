...
{
	// NITの数を返す
	return static_cast<DWORD>(m_NitPIDArray.size());
}
...
{
	// PMTの数を返す
	return static_cast<DWORD>(m_PmtPIDArray.size());
}
...
{
	// エレメンタリストリーム数を返す
	return static_cast<DWORD>(m_EsInfoArray.size());
}
...
{
	// TS情報数を返す
	return static_cast<DWORD>(m_TsInfoArray.size());
}
...
{
	// サービス数を返す
	return static_cast<DWORD>(m_SdtItemArray.size());
}
