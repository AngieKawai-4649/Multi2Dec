...
public:
	...
	virtual const UINT_PTR GetSyncErrNum(void) const = 0;
	virtual const UINT_PTR GetFormatErrNum(void) const = 0;
	virtual const UINT_PTR GetTransportErrNum(void) const = 0;
	virtual const UINT_PTR GetContinuityErrNum(const WORD wPID = TS_INVALID_PID) const = 0;
