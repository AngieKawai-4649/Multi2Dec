...
// IMulti2Converter
	...
	virtual const UINT_PTR GetSyncErrNum(void) const;
	virtual const UINT_PTR GetFormatErrNum(void) const;
	virtual const UINT_PTR GetTransportErrNum(void) const;
	virtual const UINT_PTR GetContinuityErrNum(const WORD wPID = TS_INVALID_PID) const;
