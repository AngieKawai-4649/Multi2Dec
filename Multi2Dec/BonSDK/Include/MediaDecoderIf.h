...
public:
	...
	virtual const UINT_PTR GetSyncErrNum(void) = 0;
	virtual const UINT_PTR GetFormatErrNum(void) = 0;
	virtual const UINT_PTR GetTransportErrNum(void) = 0;
	virtual const UINT_PTR GetContinuityErrNum(const WORD wPID = TS_INVALID_PID) = 0;
};
...
public:
	...
	virtual const UINT_PTR GetDescramblingState(const WORD wProgramID) = 0;
